...
- Favorise :
    ...
    - reproductibilité / historique / confiance.
...
- Qui evolue : actuellement 3.12[^1]
...
Derivative from Jake Van Der Plas JSM 2016
...
-   Des langages qui ont évolués
    <!--
    I would not mention the GIL removal the article you mention says:
    But, “didn’t you know that the GIL was removed” is somewhere between “misunderstanding” and “dead wrong“.
    -->
    -   et qui évoluent (ex de la [modification du Global Interpreter
        Lock
        (GIL)](https://superfastpython.com/gil-removed-from-python/))
    - [Gradual Typing](https://peps.python.org/pep-0484/)
    - Async Await and [Painting restoration](https://twitter.com/YunZhengHu/status/1400694739452796930)
...
- Poser des questions
- Tester les futures version de bibliothèque.
- Modifier le code avec peer review,
- Intéractions avec des spécialiste du domaine.
